...
#define KEY0_READ 	HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_0)
#define KEY1_READ 	HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_1)
#define KEY2_READ 	HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_2)
#define KEY3_READ 	HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_3)
...
/*
	switch(key[1].event){
		case 1:  //短按
		//HAL_UART_Transmit_Str(&huart1,(uint8_t*)"key1_event_1");
			HAL_UART_Transmit(&huart1,(uint8_t*)"2",3,10);
